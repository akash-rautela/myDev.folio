        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="h-full"
            >
              <GlowCard className="h-full flex flex-col items-center justify-between text-center group hover:scale-105 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 p-6">
